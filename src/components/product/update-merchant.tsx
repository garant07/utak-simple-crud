...
const UpdateProductComponent = (props: IProduct) => {
    ...
    return (
        <Fragment>
            <Dialog onClose={props.setOpen} open={props.open?.update} maxWidth="sm" fullWidth>
                <form onSubmit={hooks.handleSubmit(hooks.handleFormSubmit)}>
                                                    ...
                                                    <Fragment key={idx2}>
                                                        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                                                            ...
                                                            <IconButton 
                                                                ...
                                                                onClick={(evt) => hooks.handleDeleteOption(idx, optionEl.id, evt)}
                                                            >
                                                                <DeleteRoundedIcon />
                                                            </IconButton>
                                                        </Box>
                    ...
                    <DialogActions>
                        <Button variant="outlined" onClick={() => props.setOpen({ ...props.open, update: false })}>Cancel</Button>
